...
SECRET_KEY = 'django-insecure-niu+9qv@nmpt+j-65^)%@)745((0&bc357#bp@_fm*f*bxjs5*'
...
YOUR_VK_CLIENT_ID = os.environ.get("YOUR_VK_CLIENT_ID")
YOUR_VK_CLIENT_SECRET = os.environ.get("YOUR_VK_CLIENT_SECRET")
