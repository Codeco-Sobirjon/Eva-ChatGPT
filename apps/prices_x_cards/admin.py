...
@admin.register(ToBuyerUser)
class ToBuyerUserAdmin(admin.ModelAdmin):
    list_display = ('user', 'product_pocket', 'created')
    list_filter = ('created', 'product_pocket')
    search_fields = ('user__username', 'product_pocket__title')
